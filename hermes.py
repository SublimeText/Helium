# -*- coding: utf-8 -*-
# Hermes package, provides REPL and completion in interaction with Jupyter.
# Copuright (c) 2016, NEGORO Tetsuya (https://github.com/ngr-t)
#
# Portions are:
...
SETTINGS_FILE = 'Hermes.sublime-settings'
